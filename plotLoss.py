...
direc='results/Project_6/'
loss_files=[direc+"train_val_loss_0_val.txt",direc+"train_val_loss_1_val.txt",direc+"train_val_loss_2_val.txt",direc+"train_val_loss_3_val.txt",direc+"train_val_loss_4_val.txt"]
