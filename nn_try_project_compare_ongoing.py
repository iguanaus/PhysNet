...
def get_data(percentTest=.2,random_state=42):
    ...
    x = np.zeros(shape=(num_entries,12))
...
def main(output_folder,weight_name_load,spect_to_sample,sample_val,num_layers,n_hidden,percent_val):
    ...
    with tf.Session() as sess:
        ...
        for i in xrange(3,len(batch_x[0])):
            item = batch_x[0][i]
        ...
        for i in xrange(0,10):
            ...
            batch_y = np.reshape(np.array([x_4,x_9,x_20]),(1,-1))
...
if __name__=="__main__":
    ...
    #Use Project 4
    parser.add_argument("--output_folder",type=str,default='results/Project_7/')
    ...
    parser.add_argument("--spect_to_sample",type=int,default=21) #Zero Indexing
