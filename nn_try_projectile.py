...
def main(reuse_weights,output_folder,weight_name_save,weight_name_load,n_batch,numEpochs,lr_rate,lr_decay,num_layers,n_hidden,percent_val):
    ...
    if reuse_weights:
        ...
        weights.append(init_weights((x_size,10))) #First
        biases.append(init_bias(10))
        weights.append(init_weights((10,10))) #Second
        biases.append(init_bias(10))
        weights.append(init_weights((10,5)))   #Mid 5
        biases.append(init_bias(5))
        weights.append(init_weights((5,10))) #Third
        biases.append(init_bias(10))
        weights.append(init_weights((10,10))) #Fourth
        biases.append(init_bias(10))
        weights.append(init_weights((10,1))) #Out
        biases.append(init_bias(1))
